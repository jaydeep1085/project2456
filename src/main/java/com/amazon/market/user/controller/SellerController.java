package com.amazon.market.user.controller;
...
import com.amazon.market.user.dto.ProductDTO;
...
public class SellerController {
	...
	public ResponseEntity<List<ProductDTO>> getProductsOfSeller(@PathVariable String sellerid) throws Exception {
		...
		List<ProductDTO> productDTO = new RestTemplate().getForObject("http://localhost:9900/apis/products/" + sellerid,
				List.class);
